% Script HistogramPrepMultiple.m prepares the data for histogram plots,
...
function [theText]=HistogramPrepMultiple(fullFileName,Legend_label, histogram_numbers, histogram_percent, verbose, Solidity_threshold, Pixels_Noise)
...
for k=1 : length(fullFileName)
  ...
  disp('discarding stains with small size close to picture resolution, and stains containing large empty areas');
